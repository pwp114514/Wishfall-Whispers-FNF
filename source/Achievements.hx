...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["She's a Keeper",			"Beat Prologue (Zeal Campaign) with no Misses.",	'tutorial_nomiss',			false],
		["No More Tricks",			"Beat Prologue (Zeal Campaign) on Lucid.",	'tutorial_lucid',			false],
		["Sweet Dreams",			"Beat Prologue (Bloom Campaign) on Hard with no Misses.",	'tutorialb_nomiss',			false],
		["My Deepest Desire",		"Beat Prologue (Bloom Campaign) on Lucid.",	'tutorialb_lucid',			false],
		["Temporal Traveler",		"Played at night, morning, day, and evening.",				'menu_alltime',			true],
		//["In Another Life",		"Beat Prologue (Bloom Campaign) on Lucid with no Misses.",				'week1_nomiss',			false],
		//["What Could've Been",		"Beat Prologue (Bloom Campaign) on Lucid with no Misses.",				'week1_nomiss',			false],
