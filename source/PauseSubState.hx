...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		{
			var songText:Alphabet = new Alphabet(0, (70 * i) + 30, menuItems[i], true, false, 0.05, 0.8);
	...
	function regenMenu():Void {
		...
		for (i in 0...menuItems.length) {
			var item = new Alphabet(0, 70 * i + 30, menuItems[i], true, false, 0.05, 0.8);
